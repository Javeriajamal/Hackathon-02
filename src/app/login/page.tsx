export default function Login(){
  return(
    <div className="h-screen">
      <h1 className="xs:text-2xl xs:font-bold xs:flex xs:justify-center mt-40">Log In to Exclusive</h1> 
    <form className="space-y-4 font-[sans-serif] text-[#333] max-w-md mx-auto mt-20">
      ...
      <button type="button"
        className="px-6 py-2.5 w-full !mt-8 text-sm bg-[#007bff] hover:bg-blue-600 text-white rounded active:bg-[#006bff]">Log in</button>
    </form>
    </div>
  )
}