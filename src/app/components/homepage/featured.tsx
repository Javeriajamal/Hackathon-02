export default function Featured(){
    return(
        ...
        <div className="grid xs:grid-cols-2 xs:gap-4 xs:mx-6 xs:mt-5">
            <img src="/images/Products 1.png" alt="" className="xs:h-40 xs:w-44" />
            <img src="/images/Products2.png" alt="" className="xs:h-40 xs:w-44" />
            <img src="/images/Products 3.png" alt="" className="xs:h-40 xs:w-44 xs:mt-4" />
            <img src="/images/Products 4.png" alt="" className="xs:h-40 xs:w-44 xs:mt-4" />
