  ...
  return(
    <footer className="font-sans tracking-wide bg-gray-50 px-10 pt-12 pb-6">
      <div className="xs:flex xs:flex-wrap justify-between gap-10 xl:flex-row">
        <div className="max-w-md xl:ml-44">
          <a href='javascript:void(0)'>
            <img src="/images/Logo.png" alt="logo" className='w-36 ' />
          </a>
          <div className="mt-6">
            <p className="text-gray-600 leading-relaxed text-sm xl:w-80">Vivamus tristique odio sit amet velit semper, <br /> eu posuere turpis interdum. <br />
        ...
        <div className="max-lg:min-w-[140px] xl:pr-96">
      ...
      <div className="xs:h left-[1196px] top-[80px] xs:mt-14 xl:ml-[970px] xl:-mt-56 ">
        
        <h2 className="font-inter font-medium text-[14px] tracking-[0.06em] uppercase text-[#9A9CAA] ">Newsletter</h2>
        
        <div className=" xs:w-auto xs:h-10 xs:mt-8 border-2 rounded-md xl:w-52 xl:flex xl:gap-6 xl:h-12 ">
          <input className="bg-white border-[#333435] ml-3 pt-1" 
          type="text"
          placeholder="Your email" />
          
        
        <button className="flex justify-center items-center xs:px-[20px] py-[10px] gap-[20px] bg-[#029FAE] rounded-[8px] xs:mt-4 xl:h-11 xl:-mt-0 "><span className="w-[79px] h-[18px] font-inter text-[16px] leading-[110%] text-center capitalize text-white xl:w-[60px] xl:text-[14px]  ">Subscribe</span></button>
